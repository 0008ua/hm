...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div *ngIf=\"product\" class=\"product-it\" fxLayout=\"column\">\r\n  <img class=\"product-it__picture\" fxFlex (click)=\"openDialog()\" [src]=\"productPicture.link + '/' + product.picture\"\r\n    alt=\"product picture\">\r\n  <div *ngIf=\"allowTo('manager')\" class=\"product-it__editor\" fxLayout=\"row\">\r\n    <button mat-button (click)=\"edit()\" fxFlex>Редагувати</button>\r\n    <button mat-button (click)=\"deleteProduct()\" fxFlex>Видалити</button>\r\n  </div>\r\n  <div class=\"product-it__info\">\r\n    <div class=\"cell product-it__info-main\">\r\n      <p>\r\n        <i class=\"item far fa-eye\"></i>\r\n        <span class=\"item\">{{product.views}}</span>\r\n      </p>\r\n      <p>\r\n        <i class=\"item fa fa-calendar\"></i>\r\n        <span class=\"item\">{{product.createdAt | date: 'dd-MM-yy'}}</span>\r\n      </p>\r\n    </div>\r\n    <div class=\"cell product-it__info-name\" fxLayoutAlign=\"center center\">\r\n      <span>{{product.name}}</span>\r\n    </div>\r\n  </div>\r\n</div>\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\r\n  <div class=\"row\" fxLayout=\"row\">\r\n    <div class=\"cell\" fxFlex=\"100\" fxLayoutAlign=\"center center\">\r\n      <mat-button-toggle-group aria-label=\"Sort order\" [ngModel]=\"sortToggle\" (ngModelChange)=\"onToggle($event)\">\r\n        <mat-button-toggle [value]=\"SortTypes.Views\">{{'popular' | translate}}</mat-button-toggle>\r\n        <mat-button-toggle [value]=\"SortTypes.CreatedAt\">{{'last' | translate}}</mat-button-toggle>\r\n      </mat-button-toggle-group>\r\n    </div>\r\n  </div>\r\n</div>\r\n<div class=\"container animationAppear05s\" *ngIf=\"!navLoading\">\r\n  <div class=\"row\" fxLayout=\"row\" fxLayoutAlign=\"center center\">\r\n    <div class=\"cell\" fxFlex=\"100\">\r\n      <mat-chip-list aria-label=\"feed\" fxLayoutAlign=\"center center\">\r\n        <mat-chip *ngFor=\"let feedItem of feedSiblings\" fxFlex=\"100\" fxLayoutAlign=\"center center\"\r\n          [routerLink]=\"['/products', feedItem._id]\" (click)=\"sidenavClose()\"\r\n          [queryParams]=\"{seoTitle: feedItem[sharedService.createLangField('seoTitle')], seoMeta: feedItem[sharedService.createLangField('seoMeta')]}\"\r\n          [routerLinkActive]=\"['chips_active']\" [routerLinkActiveOptions]=\"{exact: true}\">\r\n          <span>\r\n            {{feedItem[sharedService.createLangField('name')]}}\r\n          </span>\r\n        </mat-chip>\r\n      </mat-chip-list>\r\n    </div>\r\n  </div>\r\n</div>");
...
/*!****************************************!*\
  !*** ./src/app/actions/app.actions.ts ***!
  \****************************************/
/*! exports provided: AppActionTypes, LoadAppNav, LoadAppNavSuccess, LoadAppProducts, LoadAppProductsSuccess, LoadAppLang, LoadAppLangSuccess, LoadApp, LoadAppSuccess, LoadAppFailure */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoadAppLang", function() { return LoadAppLang; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoadAppLangSuccess", function() { return LoadAppLangSuccess; });
...
(function (AppActionTypes) {
    ...
    AppActionTypes["LoadAppLang"] = "[App] Load App Lang";
    AppActionTypes["LoadAppLangSuccess"] = "[App] Load App Lang Success";
...
class LoadAppLang {
    constructor() {
        this.type = AppActionTypes.LoadAppLang;
        // constructor(public payload: { lang: string }) { }
    }
}
class LoadAppLangSuccess {
    constructor(payload) {
        this.payload = payload;
        this.type = AppActionTypes.LoadAppLangSuccess;
    }
}
class LoadApp {
    constructor(payload) {
...
/*!*************************************************!*\
  !*** ./src/app/actions/product-form.actions.ts ***!
  \*************************************************/
/*! exports provided: ProductFormActionTypes, LoadProductForms, LoadProductFormsSuccess, LoadProductFormsFailure, AddProductForms, ResetProductForms, ResetProductFormsPictureField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ResetProductFormsPictureField", function() { return ResetProductFormsPictureField; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
(function (ProductFormActionTypes) {
    ...
    ProductFormActionTypes["ResetProductFormsPictureField"] = "[ProductForm] Reset ProductForms Picture Field";
...
class ResetProductFormsPictureField {
    constructor() {
        this.type = ProductFormActionTypes.ResetProductFormsPictureField;
    }
}
...
/* harmony import */ var _actions_app_actions__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./actions/app.actions */ "./src/app/actions/app.actions.ts");
...
let AppComponent = class AppComponent {
    constructor(userService, sharedService, store, router, route, titleService, metaService, translate) {
        ...
        this.store.dispatch(new _actions_app_actions__WEBPACK_IMPORTED_MODULE_12__["LoadAppLang"]());
    }
    ngOnInit() {
        ...
        store$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(appStore => appStore.lang)) // fires on lang changed
        )
            .subscribe((result) => {
            ...
            const seoTitle = data.dataTitle || paramMap.get(this.sharedService.createLangField('seoTitle'))
                || src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"][this.sharedService.createLangField('seoTitle')];
            const seoMeta = data.dataMeta || paramMap.get(this.sharedService.createLangField('seoMeta'))
                || src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"][this.sharedService.createLangField('seoMeta')];
...
AppComponent.ctorParameters = () => [
    ...
    { type: _services_shared_service__WEBPACK_IMPORTED_MODULE_13__["SharedService"] },
...
let AppEffects = class AppEffects {
    constructor(actions$, store$, catalogService, dbService, translate) {
        ...
        //   );
        this.loadLang = this.actions$
            .pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_actions_app_actions__WEBPACK_IMPORTED_MODULE_6__["AppActionTypes"].LoadAppLang), 
        // map((action: LoadAppNav) => action.payload),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(_ => this.translate.onLangChange), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((event) => new _actions_app_actions__WEBPACK_IMPORTED_MODULE_6__["LoadAppLangSuccess"]({
            lang: event.lang,
        })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(new _actions_app_actions__WEBPACK_IMPORTED_MODULE_6__["LoadAppFailure"](error))));
    }
};
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["Effect"])()
], AppEffects.prototype, "loadLang", void 0);
...
/***/ "./src/app/modules/product/product-it/product-it.component.scss":
/*!**********************************************************************!*\
  !*** ./src/app/modules/product/product-it/product-it.component.scss ***!
  \**********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvcHJvZHVjdC9wcm9kdWN0LWl0L3Byb2R1Y3QtaXQuY29tcG9uZW50LnNjc3MifQ== */");

/***/ }),

/***/ "./src/app/modules/product/product-it/product-it.component.ts":
/*!********************************************************************!*\
  !*** ./src/app/modules/product/product-it/product-it.component.ts ***!
  \********************************************************************/
/*! exports provided: ProductItComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProductItComponent", function() { return ProductItComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let ProductItComponent = class ProductItComponent {
...
ProductItComponent.ctorParameters = () => [
...
], ProductItComponent.prototype, "product", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ProductItComponent.prototype, "loading", void 0);
ProductItComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-product-it',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./product-it.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/product/product-it/product-it.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./product-it.component.scss */ "./src/app/modules/product/product-it/product-it.component.scss")).default]
    })
], ProductItComponent);
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var src_app_actions_app_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/actions/app.actions */ "./src/app/actions/app.actions.ts");
/* harmony import */ var src_app_actions_product_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/actions/product.actions */ "./src/app/actions/product.actions.ts");
...
let ProductNavComponent = class ProductNavComponent {
    ...
    onToggle(sort) {
        this.store.dispatch(new src_app_actions_product_actions__WEBPACK_IMPORTED_MODULE_5__["LoadingProducts"]({ loading: true }));
        this.store.dispatch(new src_app_actions_app_actions__WEBPACK_IMPORTED_MODULE_4__["LoadAppProducts"]({ sort, skip: 0, ProductsAction: src_app_actions_product_actions__WEBPACK_IMPORTED_MODULE_5__["LoadProducts"] }));
    }
    sidenavClose() {
...
/* harmony import */ var _product_it_product_it_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./product-it/product-it.component */ "./src/app/modules/product/product-it/product-it.component.ts");
...
ProductModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _product_it_product_it_component__WEBPACK_IMPORTED_MODULE_11__["ProductItComponent"],
        ],
        imports: [
...
let FeedbackComponent = class FeedbackComponent {
    constructor(location, sharedService, matSnackBar, translate) {
...
function reducer(state = initialState, action) {
    switch (action.type) {
        case _actions_app_actions__WEBPACK_IMPORTED_MODULE_2__["AppActionTypes"].LoadAppNav: { // set loading before fires effect on this action
        ...
        case _actions_app_actions__WEBPACK_IMPORTED_MODULE_2__["AppActionTypes"].LoadAppLangSuccess:
...
function productFormReducer(state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case _actions_product_form_actions__WEBPACK_IMPORTED_MODULE_2__["ProductFormActionTypes"].ResetProductForms:
            return Object.assign({}, state, initialState);
        case _actions_product_form_actions__WEBPACK_IMPORTED_MODULE_2__["ProductFormActionTypes"].ResetProductFormsPictureField:
            return Object.assign({}, state, { picture: initialState.picture });
